...
ipcMain.on('open-database-window', function () {
  ...
  databaseWindow.loadURL( path.join(__dirname, `./dist/index.html`),);
...
ipcMain.on("open-maptool-backdrop-window", function () {
  ...
  maptoolBackdropWindow.loadURL('file://' + __dirname + '/dist/maptoolBackdrop.html');
...
function openMapToolWindow(callback) {
  ...
  createMapToolWindow(function (window) {
    ...
    window.maximize();
    window.loadURL('file://' + __dirname + '/dist/mappingTool.html');
...
ipcMain.on('open-generator-window', function () {
  ...
  generatorWindow.loadURL('file://' + __dirname + '/dist/generators.html');
...
function openAddMapToolStuffWindow() {
  ...
  mapToolAddWindow.loadURL('file://' + __dirname + '/dist/addMapToolStuff.html');
...
function openMassStatblockImporterWindow(){
  ...
  massStatblockImporterWindow.loadURL('file://' + __dirname + '/dist/statblockImporter.html');
...
function openMassTokenImporterWindow() {
  ...
  massTokenImporterWindow.loadURL('file://' + __dirname + '/dist/tokenImporter.html');
...
function openAboutWindow() {
  ...
  aboutWindow.loadURL('file://' + __dirname + '/dist/about.html');
...
function openSettingsWindow() {
  ...
  settingsWindow = new BrowserWindow({
    ...
    width: 500,
    frame: false,
    icon: "./dist/css/img/settings.png",
    webPreferences: {
      nodeIntegration: true,
      enableRemoteModule: true
    }
  ...
  settingsWindow.loadURL('file://' + __dirname + '/dist/settings.html');
...
function createWindow() {
  ...
  loading = new BrowserWindow({
    width: 200, height: 200, show: false, frame: false, transparent: true, icon: "./dist/css/img/icon.png", webPreferences: {
      nodeIntegration: true,
      enableRemoteModule: true
    }
  });
  ...
  loading.once('show', () => {
    mainWindow = new BrowserWindow(
      {
        width: 1250, frame: false, height: 850, icon: "./dist/css/img/icon.png", show: false,
        webPreferences: {
