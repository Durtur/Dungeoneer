...
class Menu {
  static initialize() {
    ...
    document.getElementById("fog_of_war_hue_selector").onchange = function (
      event
    ) {
    ...
    document.getElementById("background_size_slider").oninput = function (
      event
    ) {
    ...
    document.getElementById("foreground_button").onclick =
      getForegroundFromFile;
    document.getElementById("foreground_menu_button").onclick =
      getForegroundFromFile;
    ...
    document.getElementById("background_menu_button").onclick =
      getBackgroundFromFile;
    document.getElementById("background_button").onclick =
      getBackgroundFromFile;
    document.getElementById("overlay_button").onclick = getOverlayFromFile;
    document.getElementById("clear_overlay_button").onclick = () =>
      setMapOverlay(null);
