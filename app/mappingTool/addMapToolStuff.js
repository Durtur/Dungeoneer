...
document.addEventListener("DOMContentLoaded", (e) => {
    ...
    dataAccess.getSettings(settings => {
        effectFilePath = settings.maptool.effectFilePath ? settings.maptool.effectFilePath : defaultEffectPath;
    })
...
function saveEffect() {
    ...
    for (var i = 0; i < allPaths.length; i++) {
        ...
        var newPath = pathModule.join(effectFilePath, effectName + i + fileEnding);
